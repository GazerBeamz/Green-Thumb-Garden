<!-- filepath: c:\xampp\htdocs\greenthumb_garden\admin\admin_profile.php -->
<?php
...
$query = "SELECT firstname, lastname, username, email, profile_image FROM users WHERE id = '$admin_id'";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $updateQuery = "UPDATE users SET firstname = '$firstname', lastname = '$lastname', username = '$username', email = '$email', profile_image = '$profileImage' WHERE id = '$admin_id'";
...
<head>
    ...
    <title>Admin Profile - Green Thumb Garden</title>
                ...
                <div class="profile-image-wrapper">
                    <form method="POST" action="" enctype="multipart/form-data" id="profileForm">
                        <label for="profile_image">
                            <img src="../assets/profiles/<?php echo htmlspecialchars($admin['profile_image'] ?: 'profile-placeholder.png'); ?>" 
                                 alt="Profile Picture" 
